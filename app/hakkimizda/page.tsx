  ...
  return (
    <main className="min-h-screen bg-[var(--bg)] text-[var(--text)]" style={{ fontFamily: "var(--font-barlow), Arial, sans-serif" }}>
      <div className="max-w-4xl mx-auto px-6 py-16">
        ...
        {/* HERO */}
        <div className="mb-16">
          <div className="text-[var(--accent-text)] text-xs font-black tracking-widest uppercase mb-4">Hakkımızda</div>
          ...
          <p className="text-[var(--text-2)] text-lg leading-relaxed max-w-2xl">
            Tulpar Assist, çekici ve yol yardım sektöründe <span className="text-[var(--text)] font-bold">20 yılı aşkın saha tecrübesinin</span> üzerine
        ...
        {/* HİKAYE */}
        <div className="bg-[var(--panel)] border border-[var(--border)] rounded-3xl p-8 md:p-12 mb-8">
          <h2 className="font-black text-2xl md:text-3xl uppercase italic mb-4" style={{ letterSpacing: "-0.01em" }}>
            Neden Tulpar?
          </h2>
          <div className="text-[var(--text-2)] text-sm md:text-base leading-relaxed space-y-4">
            <p>
            ...
            <p>
              ...
              <span className="text-[var(--text)] font-semibold"> doğru firmaya, doğru fiyatla, güven içinde ulaşamamak.</span> Tulpar
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
          ...
          <div className="bg-[var(--panel)] border border-[var(--border)] rounded-2xl p-8">
            <div className="text-xs font-black tracking-widest uppercase bg-[#5C7386]/10 text-[var(--text-2)] border border-[var(--border)] px-3 py-1.5 rounded-full inline-block mb-6">
            ...
            <ul className="space-y-3 text-sm text-[var(--text-2)]">
              {[
                ...
                <li key={m} className="flex items-start gap-3">
                  <span className="w-5 h-5 rounded-full bg-[var(--hover)] border border-[var(--border-2)] text-[var(--text-2)] text-xs flex items-center justify-center font-black flex-shrink-0 mt-0.5">✓</span>
                  {m}
                </li>
              ))}
            </ul>
        ...
        <div className="mt-12 pt-6 border-t border-[var(--border)] flex gap-6 text-sm">
          ...
          <Link href="/gizlilik" className="text-[var(--text-3)] hover:text-[var(--text-2)] transition">Gizlilik</Link>
          <Link href="/kullanim-sartlari" className="text-[var(--text-3)] hover:text-[var(--text-2)] transition">Kullanım Şartları</Link>
        </div>
      </div>
    </main>
  );
