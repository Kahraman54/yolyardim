  ...
  return (
    <main className="min-h-screen bg-[#0B0F14] text-[#F5F8FA] px-6 py-16" style={{ fontFamily: "var(--font-barlow), Arial, sans-serif" }}>
      <div className="max-w-3xl mx-auto">
        ...
        <p className="text-[#5C7386] text-sm mb-10">Son güncelleme: Temmuz 2026</p>

        <div className="space-y-8 text-[#9DB4C6] text-sm leading-relaxed">
          <section>
            <h2 className="text-[#F5F8FA] font-black text-lg uppercase mb-2">1. Hizmetin Tanımı</h2>
            <p>Tulpar Assist, yolda kalan sürücüleri çekici, kurtarma, lastik, akü, yakıt ve çilingir hizmeti veren bağımsız tedarikçi firmalarla buluşturan bir <span className="text-[#F5F8FA] font-semibold">aracı platformdur</span>. Yol yardım hizmetinin kendisi, platforma kayıtlı bağımsız tedarikçiler tarafından verilir.</p>
          </section>

          <section>
            <h2 className="text-[#F5F8FA] font-black text-lg uppercase mb-2">2. Tarafların Sorumlulukları</h2>
          ...
          <section>
            <h2 className="text-[#F5F8FA] font-black text-lg uppercase mb-2">3. Fotoğraflı Teslim Kaydı</h2>
          ...
          <section>
            <h2 className="text-[#F5F8FA] font-black text-lg uppercase mb-2">4. Hesap ve Kullanım</h2>
            <ul className="list-disc pl-5 space-y-1">
          ...
          <section>
            <h2 className="text-[#F5F8FA] font-black text-lg uppercase mb-2">5. Sorumluluk Sınırı</h2>
          ...
          <section>
            <h2 className="text-[#F5F8FA] font-black text-lg uppercase mb-2">6. İletişim</h2>
            <p>Sorularınız için: <a href="mailto:tunahank@tulparassist.com" className="text-[#00D4FF]">tunahank@tulparassist.com</a></p>
          </section>
        </div>
        ...
        <div className="mt-12 pt-6 border-t border-[#5C7386]/20 flex gap-6 text-sm">
          ...
          <Link href="/gizlilik" className="text-[#00D4FF] font-semibold">Gizlilik Politikası →</Link>
        </div>
      </div>
    </main>
  );
