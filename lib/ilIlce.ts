export const ilIlceler: Record<string, string[]> = {
  ...
  "Burdur": ["Altınyayla","Bucak","Çavdır","Çeltikçi","Gölhisar","Kemer","Merkez","Tefenni","Yeşilova"],
  ...
  "Erzurum": ["Aşkale","Aziziye","Çat","Hınıs","Horasan","İspir","Karaçoban","Karayazı","Köprüköy","Merkez","Narman","Olru","Oltu","Palandöken","Pasinler","Pazaryolu","Şenkaya","Tekman","Tortum","Uzundere","Yakutiye"],
  "Eskişehir": ["Alpu","Beylikova","Çifteler","Günyüzü","Han","İnönü","Mahmudiye","Mihalgazi","Mihalıççık","Odunpazarı","Sarıcakaya","Seyitgazi","Sivrihisar","Tepebaşı"],
  "Gaziantep": ["Araban","İslahiye","Karkamış","Nizip","Nurdağı","Oğuzeli","Şahinbey","Şehitkamil","Yavuzeli"],
  "Giresun": ["Alucra","Bulancak","Çamoluk","Çanakçı","Dereli","Doğankent","Espiye","Eynesil","Görele","Güce","Keşap","Merkez","Özgüven","Piraziz","Şebinkarahisar","Tirebolu","Yağlıdere"],
...
export const iller = Object.keys(ilIlceler).sort();
